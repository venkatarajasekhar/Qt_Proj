...
#include "../../NLP_FINAL/inputdialog.h"
...
QT_MOC_LITERAL(4, 31, 21)
    ...
    "InputDialog\0newWordAdded\0\0list\0"
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newWordAdded((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        ...
        {
            typedef void (InputDialog::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InputDialog::newWordAdded)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void InputDialog::newWordAdded(QStringList _t1)
{
