...
#include "../../NLP_FINAL/NLP_FINAL/loadfilethread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoadFileThread_t, stringdata) + ofs \
...
const QMetaObject LoadFileThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_LoadFileThread.data,
      qt_meta_data_LoadFileThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LoadFileThread.stringdata))
